...
export default function CoverFlowCarousel({
    ...
    const cardWidth = useMemo(() => {
        ...
        return Math.min(
            Math.max(carouselWidth * 0.72, 400),
            1080
        );
    }, [carouselWidth]);
    ...
    const changeIndex = useCallback(
        ...
        [activeIndex, isAnimating, onItemChange, totalItems]
    );
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-slate-700/70 bg-[linear-gradient(145deg,#151a24_0%,#0d1119_55%,#10151f_100%)] px-3 py-5 shadow-[0_25px_90px_rgba(0,0,0,0.38)] sm:px-6 sm:py-6 md:px-8 md:py-7">
                ...
                >
                    ...
                    <button
                        ...
                        onClick={goNext}
                        disabled={
                            activeIndex === totalItems - 1 || isAnimating
                        }
                ...
                <div className="relative mt-3 flex items-center justify-center gap-2 sm:mt-4 sm:gap-3">
